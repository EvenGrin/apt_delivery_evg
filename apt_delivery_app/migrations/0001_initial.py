...
import apt_delivery_app.models.order
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_date', models.DateTimeField(default=apt_delivery_app.models.order.get_default_created_at, verbose_name='Дата и время получения заказа')),
                ('result', models.CharField(blank=True, max_length=50, null=True, verbose_name='Причина отказа')),
                ('user_comment', models.TextField(blank=True, help_text='Не обязательное поле', verbose_name='Комментарий пользователя к заказу')),
