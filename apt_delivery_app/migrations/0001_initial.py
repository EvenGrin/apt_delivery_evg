# Generated by Django 5.0.7 on 2025-03-05 09:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.date(2025, 3, 6), verbose_name='Дата')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_date', models.DateTimeField(default=apt_delivery_app.models.m_order.get_default_created_at, verbose_name='Дата и время получения заказа')),
